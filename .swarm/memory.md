# fg-data-profiling (oasis fork) — Memory (append-only)

---

**2026-05-04** — Fork initialized at oasis-main/fg-data-profiling
Forked from Data-Centric-AI-Community/fg-data-profiling (MIT, descended from ydataai/ydata-profiling MIT). Default branch `develop`. Reason for fork: oasis-data cloud product line — custom branding, better social collaboration, tighter integration with Oasis ecosystem (oasis-auth, oasis-cloud, oasis-dashboard).
